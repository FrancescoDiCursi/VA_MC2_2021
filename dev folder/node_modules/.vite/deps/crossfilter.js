...
var require_crossfilter = __commonJS({
  "node_modules/crossfilter/crossfilter.js"(exports) {
    (function(exports2) {
      ...
      function heapselect_by(f) {
        var heap2 = heap_by(f);
        function heapselect2(a, lo, hi, k) {
      ...
      function insertionsort_by(f) {
        function insertionsort2(a, lo, hi) {
      ...
      function quicksort_by(f) {
        var insertionsort2 = insertionsort_by(f);
        function sort(a, lo, hi) {
          return (hi - lo < quicksort_sizeThreshold ? insertionsort2 : quicksort2)(a, lo, hi);
        }
        function quicksort2(a, lo, hi) {
      ...
      function crossfilter_filterExact(bisect2, value) {
        return function(values) {
          var n = values.length;
          return [bisect2.left(values, value, 0, n), bisect2.right(values, value, 0, n)];
        };
      }
      function crossfilter_filterRange(bisect2, range) {
      ...
      exports2.crossfilter = crossfilter;
      function crossfilter() {
        ...
        function dimension(value) {
          ...
          function filterExact(value2) {
            return filterIndexBounds((refilter = crossfilter_filterExact(bisect, value2))(values));
          }
          ...
          function group(key) {
            ...
            var groups, groupIndex, groupWidth = 8, groupCapacity = crossfilter_capacity(groupWidth), k = 0, select, heap2, reduceAdd, reduceRemove, reduceInitial, update = crossfilter_null, reset = crossfilter_null, resetNeeded = true, groupAll3 = key === crossfilter_null;
            ...
            function add2(newValues2, newIndex2, n0, n1) {
              var oldGroups = groups, reIndex = crossfilter_index(k, groupCapacity), add3 = reduceAdd, initial = reduceInitial, k0 = k, i0 = 0, i1 = 0, j, g0, x0, x1, g, x;
              if (resetNeeded)
                add3 = initial = crossfilter_null;
              ...
              while (i1 < n1) {
                ...
                groups[k] = g;
                while (!(x1 > x)) {
                  groupIndex[j = newIndex2[i1] + n0] = k;
                  if (!(filters[j] & zero))
                    g.value = add3(g.value, data[j]);
                  if (++i1 >= n1)
                    break;
            ...
            function updateMany(filterOne, added, removed) {
              ...
              for (i = 0, n2 = added.length; i < n2; ++i) {
                if (!(filters[k2 = added[i]] & zero)) {
                  g = groups[groupIndex[k2]];
                  g.value = reduceAdd(g.value, data[k2]);
                }
              }
              for (i = 0, n2 = removed.length; i < n2; ++i) {
                if ((filters[k2 = removed[i]] & zero) === filterOne) {
                  g = groups[groupIndex[k2]];
                  g.value = reduceRemove(g.value, data[k2]);
                }
              }
            }
            ...
            function top2(k2) {
              var top3 = select(all(), 0, groups.length, k2);
              return heap2.sort(top3, 0, top3.length);
            }
            ...
            function reduceSum(value2) {
              return reduce(crossfilter_reduceAdd(value2), crossfilter_reduceSubtract(value2), crossfilter_zero);
            }
            function order(value2) {
              select = heapselect_by(valueOf);
              heap2 = heap_by(valueOf);
              function valueOf(d) {
...
// node_modules/crossfilter/index.js
var require_crossfilter2 = __commonJS({
  "node_modules/crossfilter/index.js"(exports, module) {
    module.exports = require_crossfilter().crossfilter;
  }
});

// dep:crossfilter
var crossfilter_default = require_crossfilter2();
export {
  crossfilter_default as default
};
